...
public struct ChatMessageQuoteViewContent<ExtraData: ExtraDataTypes> {
    /// The quoted message.
...
/// The avatar position in relation with the text message.
public enum ChatMessageQuoteAvatarAlignment {
...
open class _ChatMessageQuoteView<ExtraData: ExtraDataTypes>: _View, UIConfigProvider {
    ...
    public var content: ChatMessageQuoteViewContent<ExtraData>? {
        didSet {
